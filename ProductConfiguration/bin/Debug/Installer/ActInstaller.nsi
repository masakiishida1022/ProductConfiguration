...
;CreateShortCut "$DESKTOP\ActX1.12.lnk" "$INSTDIR\InstallerProject.exe" "" "$INSTDIR\favicon.ico" 0
CreateShortCut "$DESKTOP\ActX1.4.lnk" "$INSTDIR\InstallerProject.exe"
